            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-lg-2 ml-auto">
                        ...
                        <div className="social-section text-md-left">
                            <ul className="text-center">
                                <li>
                                    <a href="#1" className="btn-floating  btn-fb waves-effect waves-light">
                                        <i className="fa fa-facebook"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#2" className="btn-floating  btn-ins waves-effect waves-light">
                                        <i className="fa fa-instagram"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#3" className="btn-floating  btn-tw waves-effect waves-light">
                                        <i className="fa fa-twitter"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#4" className="btn-floating  btn-yt waves-effect waves-light">
                                        <i className="fa fa-youtube"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#5" className="btn-floating  btn-li waves-effect waves-light">
                                        <i className="fa fa-linkedin"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#6" className="btn-floating  btn-dribbble waves-effect waves-light">
                                        <i className="fa fa-dribbble left"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#7" className="btn-floating  btn-pin waves-effect waves-light">
                                        <i className="fa fa-pinterest"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#8" className="btn-floating  btn-gplus waves-effect waves-light">
                    ...
                    <div className="col-lg-2">
                        ...
                        <ul>
                            <li>
                                <a href="#9">Store Delivery</a>
                            </li>
                            <li>
                                <a href="#10">Online Delivery</a>
                            </li>
                            <li>
                                <a href="#11">Delivery Terms &amp; Conditions</a>
                            </li>
                            <li>
                                <a href="#12">Tracking</a>
                            </li>
                        </ul>
                    </div>
                    <div className="col-lg-2">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#14">Contact Us</a>
                            </li>
                            <li>
                                <a href="#15">Return Policy</a>
                            </li>
                            <li>
                                <a href="#16">Product Registration</a>
                            </li>
                        </ul>
